...
final class VersionHistoryViewController: NSViewController {
    ...
    private static let entries = [
        ...
        VersionEntry(
            ...
            date: "2026-07-06",
            changes: [
                "截图设置中新增“归档整理”选项，可选择极致归纳、开发需求、润色或原文。",
                "截图归档默认回到“极致归纳”，更适合把看到的内容沉淀成知识点。",
                "归档实际使用的整理模式会写入 Markdown front matter，保存目录和日期子文件夹规则保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.6 (Build 550)",
            date: "2026-07-06",
            changes: [
                "截图归档默认智能整理模式从“极致归纳”改为“开发需求”。",
                "归档 Markdown 的 front matter 会记录 `mode: \"开发需求\"`，便于后续在 Obsidian 中筛选。",
                "归档保存目录、日期子文件夹、文件名前缀和 OCR 原文保留规则保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.6 (Build 549)",
            date: "2026-07-06",
            changes: [
                "截图归档文件现在固定保存到 Obsidian 需求池下的“归档（未处理）”文件夹。",
                "归档会按日期自动建立子文件夹，例如 2026-07-06，当天截图归入当天目录。",
                "次日归档会自动进入新的日期子文件夹，普通需求池和闪念胶囊保存位置保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.6 (Build 548)",
            date: "2026-07-06",
            changes: [
                "截图归档整理过程中，顶部会显示“归档整理中”toast，和页面内常驻状态同步给出反馈。",
                "归档处理中 toast 会保持到完成，由“归档已保存”或失败提示替换，避免长任务期间反馈消失。",
                "保留页面内“归档整理中”状态和并行归档保护，后一张截图不会取消前一张归档。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.5 (Build 547)",
            date: "2026-07-06",
            changes: [
                "明确录音快捷键切换规则：我开、我关；我开、他开；先关我，再开他。",
                "同一入口的 key-down 不再提前结束录音，避免 key-up 又立刻开启新录音导致胶囊关不掉。",
                "不同入口切换时继续保留旧录音后台处理，并立即打开新入口录音。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.5 (Build 546)",
            date: "2026-07-06",
            changes: [
                "修复后台录音任务完成后胶囊可能无法自动隐藏的问题。",
                "将“允许更新当前 UI 文案”和“任务完成后允许隐藏胶囊”拆成两个判断，保留后台任务不丢的同时恢复胶囊关闭行为。",
                "恢复同一快捷键的 toggle 语义：key-down 不直接结束录音，避免 key-up 又立刻开启新录音。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.5 (Build 545)",
            date: "2026-07-06",
            changes: [
                "截图归档改为独立后台完成，后一张截图不会取消前一张已经开始的归档。",
                "主录音和闪念胶囊互切时，当前录音会进入后台识别、整理和保存，新入口会立即开始录音。",
                "语音后台任务不再只有一个最新任务，旧录音结果不会因为新录音开始而被判为过期丢弃。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.4 (Build 544)",
            date: "2026-07-06",
            changes: [
                "截图归档生成的 Markdown 文件名增加“归档”前缀，并使用更短的“归档-YYMMDD-HHmm-主题.md”格式。",
                "归档整理中会在页面内保持“归档整理中”状态，成功后切换为“归档已保存”并自动消失。",
                "普通需求池文件和闪念胶囊文件名保持不变，方便在同一个 Obsidian 需求池目录中区分知识归档。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.4 (Build 543)",
            date: "2026-07-06",
            changes: [
                "截图工具栏新增“归档”按钮，可把选区内容 OCR 后按极致归纳整理成知识点。",
                "归档结果会写入 Obsidian 需求池，生成日期+主题命名的 Markdown，并保留 OCR 原文用于追溯。",
                "归档不会改动剪贴板；AI 归纳失败但 OCR 成功时，会以 warning 保存 OCR 原文，避免知识素材丢失。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.4 (Build 542)",
            date: "2026-07-06",
            changes: [
                "自动整理模式下，经典胶囊顶部不再只显示“自动”，而是显示当前上下文解析出的实际整理模式。",
                "自动解析出的整理模式使用黄色字体强调；手动选择原文、润色、开发需求或极致归纳时保持默认字体颜色。",
                "胶囊点击切换整理模式、录音目标 App 更新时都会同步刷新模式名和强调色，避免自动模式显示过期。"
            ]
        ),
        VersionEntry(
        ...
        VersionEntry(
            ...
            date: "2026-07-05",
            changes: [
                "完成本地 FunASR 模型下载后的首轮能力验证记录，为 Pro ASR 改造进入分支合并做收口。",
                "确认 Paraformer Contextual 的 hotword 能在解码/上下文阶段生效，优先作为开发术语热词 ASR 主候选。",
                "确认 Fun-ASR-Nano-2512 可运行但需要补齐 Python runtime 依赖，并显式指向 FunASR 包内 remote_code；FSMN-VAD 与 CT-Punc 属于 ONNX runtime SDK 形态。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.1 (Build 534)",
            date: "2026-07-05",
            changes: [
                "模型面板新增本地大模型下载链接：Qwen3 8B 与 Qwen3.6 35B。",
                "大模型链接作为 Ollama 下载入口展示，不走 FunASR / ModelScope 下载器，避免把整理模型误放进 ASR 模型目录。",
                "模型面板顶部目标目录 header 增加“大模型”紧凑行，保留现有 ASR 模型下载列表和进度逻辑不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.1 (Build 533)",
            date: "2026-07-05",
            changes: [
                "修复模型下载按钮卡死：点击下载不再在主线程同步扫描 ModelScope 进程，旧下载接管检查改为后台任务。",
                "修复 /bin/ps 进程扫描的 pipe 背压死锁，先读取输出再等待退出，避免长命令行输出塞满 pipe 后卡住 App。",
                "ModelScope 下载日志改为后台持续排水，只保留失败尾部，避免下载进程 stdout/stderr 写满 pipe 后堵住。",
                "模型下载中状态显示真实 staging 目录落盘字节数，百分比由真实落盘字节和模型体积基准计算。",
                "当前 App 自己发起的下载在停止时使用 TERM 后 KILL 兜底，确保停止动作可收敛。"
            ]
        ),
        VersionEntry(
            version: "版本 1.9.0 (Build 532)",
            date: "2026-07-05",
            changes: [
                "启动期 0B staging 清理提前到启动 5 秒后执行，并写入启动日志，便于确认安装版是否实际扫描到旧下载目录。",
                "下载进程停止逻辑增强为 TERM 后 KILL 兜底，避免孤儿 ModelScope 进程忽略普通终止信号后继续卡住。",
                "修复启动期恢复检查的 Swift 6 Sendable warning，后台闭包不再捕获 FileManager 实例。",
                "新增启动期 0B staging 安全网：启动 25 秒后若临时下载目录仍没有任何文件，会清理目录并终止同路径旧 ModelScope 进程。",
                "模型下载恢复检查会在 App 启动目录准备完成后立即初始化，不依赖用户打开或滚动到模型面板。",
                "保留 1.8.9 (Build 528) 的模型下载健康检查和闪念胶囊功能说明。",
                "闪念胶囊功能行为不变：独立快捷键、蓝紫光晕胶囊、保存 Markdown 笔记且不自动粘贴。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.9 (Build 528)",
            date: "2026-07-05",
            changes: [
                "模型下载恢复检查提前到 App 启动目录准备完成后初始化，主窗口隐藏或尚未滚到模型面板时也会治理旧下载。",
                "修复模型下载状态假卡住：只要发现旧的 .downloading staging 目录，模型面板会立即接入健康检查，而不是等待异步收养成功。",
                "当 UI 显示下载中但本机没有对应 ModelScope 进程，或进程存在但 staging 长时间不增长时，会自动退出下载状态。",
                "0B staging 会回到未下载或显示可重试失败；已有半包但无进程/无增长会显示失败，避免用户误以为还在下载。",
                "点击下载前会优先接管同一目标目录下已有的 ModelScope 下载，避免覆盖安装或重试后生成多组同路径下载进程。",
                "继续保留圆形进度环和停止按钮，下载状态现在由真实进程与 staging 目录共同校验。",
                "新增“闪念胶囊”快捷键：触发后使用蓝紫光晕胶囊录音，整理结果自动保存为 Obsidian Markdown 笔记。",
                "闪念胶囊笔记保存到需求池下的“闪念胶囊”子文件夹，文件名使用 YYMMDD-HHmm-主题-idea-pill，且不会自动粘贴到当前 App。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.8 (Build 526)",
            date: "2026-07-05",
            changes: [
                "闪念胶囊中间构建记录：新增独立“闪念胶囊”快捷键，可用蓝紫光晕胶囊记录突发想法。",
                "闪念胶囊复用现有录音、final ASR、实时预览和智能整理链路，整理结果自动保存为 Markdown 笔记。",
                "本构建后续已由完整版本构建推进到 1.8.9 (Build 527)，最终安装版以 Build 527 为准。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.8 (Build 524)",
            date: "2026-07-05",
            changes: [
                "模型下载中按钮从不可点击的“下载中”改为可操作的“停止”，可立即停止下载并清理临时 staging 目录。",
                "当前 App 发起的下载会直接终止对应 ModelScope 进程；覆盖安装后接管的外部下载会按 local_dir 精确查找并停止。",
                "停止后模型回到可重新下载状态，不会把半包目录标记为可用模型。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.8 (Build 523)",
            date: "2026-07-05",
            changes: [
                "修复 Build 522 引入的主窗口启动 hang：模型下载恢复检查不再在主线程同步执行 /bin/ps。",
                "保留覆盖安装后接管正在下载模型的能力，但改为后台检查 ModelScope 进程，完成后再刷新模型行进度环。",
                "避免主窗口创建期间等待外部进程检查，降低打开窗口黑屏或不可见风险。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.7 (Build 522)",
            date: "2026-07-05",
            changes: [
                "模型下载进度支持覆盖安装后的状态恢复：如果 ModelScope 仍在写入 staging 目录，模型面板会继续显示下载中和圆形百分比进度。",
                "进程结束但当前 App 无法确认退出码时，不把 staging 目录直接标记为可用模型，避免半包被误当成下载完成。",
                "继续保留目标目录紧凑 header 和模型行列对齐。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.7 (Build 521)",
            date: "2026-07-05",
            changes: [
                "修复模型面板目标目录区域高度和 Y 轴节奏异常：目标目录从独立大卡片改为模型列表内的紧凑 header row。",
                "目标目录、路径和打开按钮改为同一行固定高度布局，避免路径位置被遮挡或占用首个模型行的视觉空间。",
                "下载中的模型行新增圆形百分比进度环，状态文字同步显示下载百分比，便于确认大模型下载是否推进。",
                "模型下载目录、下载逻辑和已下载模型持久化位置保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.7 (Build 520)",
            date: "2026-07-05",
            changes: [
                "继续修复模型列表自查发现的外层行宽问题：共享 listCard 现在会把每个列表行和分隔线约束到完整列表宽度。",
                "模型行不再按自身内容宽度居中，短模型名与长模型名共享同一左侧扫描线，更接近原生 macOS table row 行为。",
                "修复过程中发现主窗口曾保存到屏幕上方之外，已在验证时拉回屏幕内；本次不改变窗口持久化逻辑。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.6 (Build 519)",
            date: "2026-07-05",
            changes: [
                "模型列表自查修复 classic Mac HIG 空间稳定问题：行容器改为显式约束，状态点、文本列和下载按钮不再被内容宽度反向推位。",
                "修复上一版仍可能出现 FSMN-VAD、CT-Punc 等短模型名行向中间漂移的问题，所有模型名从同一视觉列开始。",
                "下载状态、模型目录、ModelScope 下载流程和 ASR 识别链路保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.6 (Build 518)",
            date: "2026-07-05",
            changes: [
                "模型列表按 classic Mac HIG 的空间稳定原则继续收口：所有模型行统一左侧状态点、中央文本、右侧下载按钮三列。",
                "修复 FSMN-VAD、CT-Punc 等短名称行因内容宽度不同而向中间跳列的问题，列表扫读路径更稳定。",
                "保持未下载为中性灰、失败才红的状态语义，下载目录和模型管理逻辑不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.6 (Build 517)",
            date: "2026-07-05",
            changes: [
                "模型面板按版式设计复核收紧状态语言：未下载模型改用中性灰点和灰字，不再被误读成错误。",
                "模型列表改成稳定三列：左侧状态点、中央文本、右侧下载按钮，避免后几行因文本宽度变化出现跳列。",
                "模型面板宽度加宽到 390，给模型名、能力说明和下载按钮留出更稳定的阅读空间。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.5 (Build 516)",
            date: "2026-07-05",
            changes: [
                "模型面板安装版视觉复核后调整模型行布局：下载按钮固定在每行标题右侧，不再被模型说明文字挤出可见区域。",
                "每行仍保留模型能力、预计大小、目标子目录和下载状态，便于确认模型会落到用户级持久目录。",
                "下载目录和 ModelScope staging / 原子提交逻辑保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.5 (Build 515)",
            date: "2026-07-05",
            changes: [
                "主窗口新增“模型”面板，列出 Fun-ASR-Nano、Contextual Paraformer、Paraformer 对照、FSMN-VAD 和 CT-Punc 候选模型。",
                "每个模型提供独立下载按钮，下载目标固定在 TypeWhale Pro 的用户级 Application Support 模型目录，覆盖安装 App 不会清理这些文件。",
                "模型下载先通过本机 ModelScope CLI 写入 staging 目录，成功后再原子替换到正式目录，避免失败下载污染可复用模型。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.5 (Build 514)",
            date: "2026-07-04",
            changes: [
                "截图翻译新增分块翻译：去重后超过 25 行的页面会按每组约 12 行串行送入模型，降低单次请求 prompt 规模。",
                "大截图翻译 loading 过程中会显示第几组/共几组，用户能看到长页面正在推进，而不是一直停在同一个状态。",
                "分块结果会合并后再展开回原始 OCR 行号，保留原有译文贴回位置、截图选择和失败处理边界。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.4 (Build 513)",
            date: "2026-07-04",
            changes: [
                "截图翻译本地 Ollama 请求改为动态超时：小截图保持 12 秒，大截图会按输入规模放宽到 24 或 30 秒。",
                "请求日志新增 timeout_seconds，后续可直接从日志判断大截图是模型耗时、超时阈值还是服务状态问题。",
                "普通智能整理和语音翻译仍保持原 12 秒超时，不改变主输入路径的等待体验。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.4 (Build 512)",
            date: "2026-07-04",
            changes: [
                "截图翻译新增 OCR 行去重快路径：重复套餐页、价格表和多列页面只把唯一文本送入模型翻译，再映射回原始截图行位置。",
                "去重只移除翻译等价的重复文案，不改变译文贴回坐标、复制保存图片或标注层行为。",
                "新增截图翻译去重回归检查，并在日志中记录压缩前后的行数，便于继续定位大截图翻译耗时。"
            ]
        ),
        VersionEntry(
            version: "版本 1.8.4 (Build 511)",
            date: "2026-07-04",
            changes: [
                "Pro 版暂时移除本地 Qwen 8B 模型入口，智能整理、自动翻译和截图翻译的本地模型选择只保留 Qwen3.6 35B。",
                "历史保存过 8B 的配置会自动迁回 Qwen3.6 35B，避免模型下拉菜单出现不可见或不可用的旧选项。",
                "截图翻译改用被动 Ollama 连接策略：本机服务不可用时不再自动唤起 Ollama App，并收紧本地截图翻译输出预算。"
            ]
        ),
        VersionEntry(
        ...
        VersionEntry(
            ...
            date: "2026-07-01",
            changes: [
                "完整版本构建：收口语音语言翻译归入智能整理体系、截图 OCR 翻译独立路径和客观润色默认提示词。",
                "安装版版本号进入 1.8.2，便于和 1.8.1 的连续本地 build 区分。",
                "本次不新增额外用户路径，只作为已提交翻译链路拆分改动的完整构建验证版本。"
            ]
        ),
        VersionEntry(
        ...
        VersionEntry(
            ...
            date: "2026-07-01",
            changes: [
                "移除 Ollama 健康态胶囊绿边的跑马灯和移动亮点效果，回到整体呼吸绿边。",
                "增强绿边呼吸光效：内侧向胶囊内部柔和辐射约 5px，外侧保留约 2px 渐变光晕。",
                "胶囊尺寸、文字布局、录音状态和风险状态边框优先级保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.7.4 (Build 488)",
            date: "2026-07-01",
            changes: [
                "Ollama 健康态胶囊绿边增强为带明显光晕的细边，不再显得过细或发暗。",
                "marquee 从多段虚线改为单个激光亮点沿边框慢速移动，并带短光迹和中心高亮。",
                "继续保持风险状态边框优先级：倒计时临近或内存高压时仍覆盖健康绿边。"
            ]
        ),
        VersionEntry(
            version: "版本 1.7.4 (Build 487)",
            date: "2026-07-01",
            changes: [
                "Ollama 健康态胶囊绿边从较厚的呼吸光晕改为更细的稳定描边。",
                "绿边新增慢速 marquee 高光，健康状态更有流动感，但不抢倒计时或内存高压等风险边框。",
                "胶囊尺寸、文字布局、录音状态和健康状态优先级保持不变。"
            ]
        ),
        VersionEntry(
            version: "版本 1.7.4 (Build 486)",
            date: "2026-07-01",
            changes: [
                "润色模式默认面向社交媒体、朋友圈、微博、Threads、小红书和聊天沟通，表达更轻松口语化。",
                "润色结果会在不改变原意的前提下自然加入 1-3 个贴合语气的 emoji，让表达更有情绪和亲和力。",
                "正式通知、技术指令、开发需求、错误排查等严肃内容仍会少加或不加 emoji，避免影响专业表达。"
            ]
        ),
        VersionEntry(
            version: "版本 1.7.3 (Build 485)",
            date: "2026-07-01",
            changes: [
                "开发需求语义纠错从固定例子扩展为泛化规则：字面表达不通时，会结合当前开发反馈语境恢复真实意图。",
                "补充“这个提示词”“把我的话”“口头禅/口癖”等新一组音近错词纠正样例。",
                "继续保护代码、路径、变量名、命令和不确定专有名词，避免把真实技术文本误改。"
            ]
        ),
        VersionEntry(
            version: "版本 1.7.3 (Build 484)",
            date: "2026-07-01",
            changes: [
                "开发需求提示词加强语义理解：先判断整句话的产品/技术语义，再做整理，不再只删除口头禅后照搬 ASR 错字。",
                "新增中文音近错词纠正规则，例如提示词、照搬、模型端、问题等上下文明确的误识别会被主动修正。",
                "保留代码、路径、变量名、命令、错误日志和不确定专有名词，避免语义纠错误伤真实技术文本。"
            ]
        ),
        VersionEntry(
            version: "版本 1.7.3 (Build 483)",
            date: "2026-07-01",
            changes: [
                "开发需求默认提示词融合 1.3 版本的轻量任务整理体验：默认克制，短句仍保持短句。",
                "保留当前版本的 coding agent 场景护栏：第一/第二人称、规则块、提示词块和原文主体不再被改成旁观者总结。",
                "复杂需求仍可按需结构化，但只有原文确实包含足够字段或用户明确要求完整需求时才启用模板。"
            ]
        ),
        VersionEntry(
        ...
        VersionEntry(
            ...
            date: "2026-06-30",
            changes: [
                "新增本地 Ollama 智能整理模型，默认使用本机 `qwen3.6:35b-mlx`，可切换到 DeepSeek v4 flash。",
