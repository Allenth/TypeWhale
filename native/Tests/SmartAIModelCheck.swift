...
struct SmartAIModelCheck {
    static func main() {
        ...
        precondition(SmartAIModel.ollamaQwen8B.provider == .ollama)
        precondition(SmartAIModel.ollamaQwen8B.engineModelName == "qwen3:8b")
        precondition(SmartAIModel.deepSeekV4Flash.provider == .deepSeek)
        precondition(!SmartAIModel.ollamaQwen35B.supportsUsageSummary)
        precondition(!SmartAIModel.ollamaQwen8B.supportsUsageSummary)
        ...
        precondition(SmartAIModel.fromStoredRawValue("qwen3:8b") == .ollamaQwen8B)
