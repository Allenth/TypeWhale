...
Current local release build in this repository is `1.5.14 (372)`. It has been built, installed locally from source, and packaged as `dist/TypeWhale-1.5.14-372.dmg`. The public GitHub DMG link above still points to the last uploaded public test artifact.
