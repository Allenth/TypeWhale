...
[Download TypeWhale-Pro-1.9.7-552.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.9.7-build552/TypeWhale-Pro-1.9.7-552.dmg)
...
[TypeWhale Pro 1.9.7 (552) Test Release](https://github.com/Allenth/TypeWhale/releases/tag/v1.9.7-build552)

当前测试版 DMG 直链：

[TypeWhale-Pro-1.9.7-552.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.9.7-build552/TypeWhale-Pro-1.9.7-552.dmg)

如果点击直链没有反应，可以打开 Release 页面，在底部 **Assets** 区域下载 `TypeWhale-Pro-1.9.7-552.dmg`，或右键链接选择“链接另存为”。
...
开源仓库不包含模型文件和运行时二进制。`TypeWhale-Pro-1.9.7-552.dmg` 内置基础 ASR/VAD 模型，可直接支持本地语音输入；但不内置 Ollama / LLM 大语言模型，智能整理仍使用用户本机已有的 Ollama 模型或已配置的云端模型。
