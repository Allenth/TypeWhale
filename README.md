...
[Download TypeWhale-1.2.13-170.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.2.13-build170/TypeWhale-1.2.13-170.dmg)
...
中文用户可以直接点击上面的链接下载安装包。如果浏览器没有开始下载，请右键链接选择“链接另存为”，或打开 [Releases](https://github.com/Allenth/TypeWhale/releases) 页面，在 **Assets** 区域下载 `TypeWhale-1.2.13-170.dmg`。
...
[TypeWhale Releases](https://github.com/Allenth/TypeWhale/releases)

当前测试版 DMG 直链：

[TypeWhale-1.2.13-170.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.2.13-build170/TypeWhale-1.2.13-170.dmg)

如果点击直链没有反应，可以打开 Release 页面，在底部 **Assets** 区域下载 `TypeWhale-1.2.13-170.dmg`，或右键链接选择“链接另存为”。
