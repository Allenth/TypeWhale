...
[TypeWhale-1.2.12-169.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.2.12-build169/TypeWhale-1.2.12-169.dmg)

如果点击直链没有反应，可以打开 Release 页面，在底部 **Assets** 区域下载 `TypeWhale-1.2.12-169.dmg`，或右键链接选择“链接另存为”。
