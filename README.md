...
[Download TypeWhale-1.2.42-199.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.2.42-build199/TypeWhale-1.2.42-199.dmg)
...
中文用户可以直接点击上面的链接下载安装包。如果浏览器没有开始下载，请右键链接选择“链接另存为”，或打开 [TypeWhale 1.2.42 (199) Test Release](https://github.com/Allenth/TypeWhale/releases/tag/v1.2.42-build199) 页面，在 **Assets** 区域下载 `TypeWhale-1.2.42-199.dmg`。
...
[TypeWhale 1.2.42 (199) Test Release](https://github.com/Allenth/TypeWhale/releases/tag/v1.2.42-build199)

当前测试版 DMG 直链：

[TypeWhale-1.2.42-199.dmg](https://github.com/Allenth/TypeWhale/releases/download/v1.2.42-build199/TypeWhale-1.2.42-199.dmg)

如果点击直链没有反应，可以打开 Release 页面，在底部 **Assets** 区域下载 `TypeWhale-1.2.42-199.dmg`，或右键链接选择“链接另存为”。
